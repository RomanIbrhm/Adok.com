...
// ---- Ambil data riwayat booking untuk user ini ----
...
<head>
    ...
    <style>
        ...
        .hero-section {
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?q=80&w=2100&auto=format&fit=crop');
        ...
        .car-card:hover, .booking-card:hover {
...
<body>
    ...
    <header id="home" class="hero-section text-white d-flex flex-column justify-content-center">
        <div class="container text-center">
            ...
            <p class="lead col-lg-8 mx-auto my-4">Rent the car of your dreams. Unbeatable prices, flexible pick-up options and much more.</p>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <?php
                                                    ...
                                                    // Menggunakan trim() untuk membersihkan nilai status
                                                    $status = trim($booking['booking_status']);
                                                    
                                                    $badge_class = 'bg-secondary';
                                                    $status_text = 'Status Tidak Dikenali'; // Teks default jika status aneh
